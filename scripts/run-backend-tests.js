...
const env = {
  ...process.env,
  GEMINI_API_KEY: process.env.GEMINI_API_KEY || "stage6-backend-test-key",
  GEMINI_MODEL: process.env.GEMINI_MODEL || "stage6-test-model",
};
...
const jestCommand =
  "node ./node_modules/jest/bin/jest.js tests/backend --runInBand --forceExit --testTimeout=20000";
